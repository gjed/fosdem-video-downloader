...
The system SHALL generate Jellyfin-compatible `.nfo`
XML sidecar files at three levels matching the TV
series model when `--jellyfin` is enabled and talks
have rich metadata (year mode):
